...
if(VIRTUOSEVPP_FOUND)
	...
	set(VIRTUOSEVPP_INCLUDE_DIRS "${VIRTUOSEAPI_INCLUDE_DIR}" "${VIRTUOSEVPP_INCLUDE_DIR}")
	set(VIRTUOSEVPP_RUNTIME_LIBRARY "${VIRTUOSEAPI_RUNTIME_LIBRARY}")
	set(VIRTUOSEVPP_RUNTIME_LIBRARY_DIRS "${VIRTUOSEAPI_RUNTIME_LIBRARY}")
