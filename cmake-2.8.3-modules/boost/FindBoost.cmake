...
ELSE (_boost_IN_CACHE)
  ...
  IF( NOT Boost_INCLUDE_DIR )
    ...
    FOREACH(_boost_VER ${_boost_TEST_VERSIONS})
      ...
      list(APPEND _boost_PATH_SUFFIXES "boost-${_boost_BOOSTIFIED_VERSION}" "boost-${_boost_VER}")
      if(WIN32)
        # For BoostPro's underscores (and others?)
        list(APPEND _boost_PATH_SUFFIXES "boost_${_boost_BOOSTIFIED_VERSION}" "boost-${_boost_VER}")
      endif()
